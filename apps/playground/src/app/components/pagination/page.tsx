  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <ComponentPreview>
          <div className="w-full">
            <Pagination currentPage={1} pageSize={25} hasNextPage basePath="/components/pagination" />
          </div>
        </ComponentPreview>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ComponentPreview>
          <div className="w-full">
            <Pagination currentPage={500} pageSize={25} hasNextPage basePath="/components/pagination" />
          </div>
        </ComponentPreview>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ComponentPreview>
          <div className="w-full">
            <Pagination currentPage={10} pageSize={25} hasNextPage={false} basePath="/components/pagination" />
          </div>
        </ComponentPreview>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ComponentPreview>
          <div className="w-full">
            <Pagination currentPage={1} pageSize={100} hasNextPage basePath="/components/pagination" />
          </div>
        </ComponentPreview>
      </section>
    </div>
