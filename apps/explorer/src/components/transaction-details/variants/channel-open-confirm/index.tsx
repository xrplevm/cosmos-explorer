...
import { ChannelOpenConfirmOverviewCard } from "./channel-open-confirm-overview-card";

export function ChannelOpenConfirmTransactionDetail(props: TransactionDetailViewProps) {
  return (
    <div className="space-y-6">
      <TransactionDetailHeader />
      <ChannelOpenConfirmOverviewCard {...props} />
