...
import { GrantAllowanceOverviewCard } from "./grant-allowance-overview-card";

export function GrantAllowanceTransactionDetail(props: TransactionDetailViewProps) {
  return (
    <div className="space-y-6">
      <TransactionDetailHeader />
      <GrantAllowanceOverviewCard {...props} />
