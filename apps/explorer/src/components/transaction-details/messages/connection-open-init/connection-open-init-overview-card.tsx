...
interface ConnectionOpenInitValue {
  signer?: string;
  client_id?: string;
  clientId?: string;
  data?: {
...
export function ConnectionOpenInitOverviewCard({
  hash,
  transaction,
  chainConfig,
  ...
  const clientId = root.client_id ?? root.clientId ?? data.client_id ?? data.clientId;
