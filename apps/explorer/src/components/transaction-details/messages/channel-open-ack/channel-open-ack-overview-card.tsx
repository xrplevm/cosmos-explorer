...
export function ChannelOpenAckOverviewCard({
  hash,
  transaction,
  chainConfig,
  ...
  const counterpartyChannelId =
    root.counterparty_channel_id ?? root.counterpartyChannelId ??
    data.counterparty_channel_id ?? data.counterpartyChannelId;
    ...
    <Card>
      ...
      <CardContent className="space-y-0">
        ...
        {counterpartyChannelId != null ? (
          <>
            <Separator />
            <DetailRow label="Counterparty Channel">
              <span className="font-mono text-xs">{counterpartyChannelId}</span>
            </DetailRow>
          </>
        ) : null}
