...
require (
	...
	github.com/coinbase/rosetta-sdk-go/types v1.6.1 // indirect
...
replace (
	...
	// resolve ambiguous import: rosetta-sdk-go v0.7.9 contains a types sub-package
	// that conflicts with the separate rosetta-sdk-go/types module
	github.com/coinbase/rosetta-sdk-go => github.com/coinbase/rosetta-sdk-go v0.10.0
	...
	// use local juno package
	github.com/forbole/juno/v6 => ../../packages/juno
